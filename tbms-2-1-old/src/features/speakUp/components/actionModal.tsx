...
import { useSaveSpeakupActionMutation } from "../../../services/Speakup/actionSave";
import { SpeakUpActionParams } from "../types/speakupTypes";
...
export const ActionModal = ({
  ...
  const [saveSpeakupAction, { isLoading, isSuccess, isError }] =
    useSaveSpeakupActionMutation();
  ...
  const handleAction = async (e: React.FormEvent) => {
    ...
    const payload: SpeakUpActionParams = {
      action: actionType,
      remarks,
      approvalActionID,
      assignedEmp,
    ...
    try {
      await saveSpeakupAction(payload).unwrap();
