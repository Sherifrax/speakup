    ...
    <header className="sticky top-0 flex w-full bg-transparent border-b-2 border-white shadow-[0_1px_4px_rgba(255,255,255,0.3)] z-[9999] backdrop-blur-none">
      <div className="flex flex-col items-center justify-between flex-grow lg:flex-row lg:px-6">
        ...
        <div className="relative">
          ...
          >
            {isLaptop ? (
              isExpanded ? <LuArrowLeftToLine /> : <LuArrowRightToLine />
            ) : (
              <svg
                width="16"
                height="12"
          ...
          <button
            ...
            className="flex items-center justify-center w-10 h-10 text-gray-700 rounded-lg z-[10000] hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 lg:hidden"
          >
            <svg
              width="24"
              height="24"
           ...
           <h1 className="text-xl font-semibold text-gray-800 dark:text-gray-200">TBMS</h1>
          </div> 
        </div>
        <div
          className={`${
